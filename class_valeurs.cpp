  ...
  for(Int_t i=0; i<4; i++)
    {
      ...
      ErrDelta2[i].push_back(SqErrA2[i]*((delta[i][0]+((F2[0]-A2[i]+F2[2]-A2[i])/(2*sqrt(F2[1]*F2[1]-(F2[2]-A2[i])*(F2[0]-A2[i])))))/(F2[2]-A2[i]))*((delta[i][0]+((F2[0]-A2[i]+F2[2]-A2[i])/(2*sqrt(F2[1]*F2[1]-(F2[2]-A2[i])*(F2[0]-A2[i])))))/(F2[2]-A2[i])));
      ErrDelta2[i].push_back(SqErrA2[i]*((delta[i][0]+(-(F2[0]-A2[i]+F2[2]-A2[i])/(2*sqrt(F2[1]*F2[1]-(F2[2]-A2[i])*(F2[0]-A2[i])))))/(F2[2]-A2[i]))*((delta[i][0]+((F2[0]-A2[i]+F2[2]-A2[i])/(2*sqrt(F2[1]*F2[1]-(F2[2]-A2[i])*(F2[0]-A2[i])))))/(F2[2]-A2[i])));
    }
  return delta;
}
  ...
  for(Int_t i=0; i<4; i++)
    {
      ...
      ErrDelta4[i].push_back(SqErrA4[i]*((delta[i][0]+((F4[0]-A4[i]+F4[2]-A4[i])/(2*sqrt(F4[1]*F4[1]-(F4[2]-A4[i])*(F4[0]-A4[i])))))/(F4[2]-A4[i]))*((delta[i][0]+((F4[0]-A4[i]+F4[2]-A4[i])/(2*sqrt(F4[1]*F4[1]-(F4[2]-A4[i])*(F4[0]-A4[i])))))/(F4[2]-A4[i])));
      ErrDelta4[i].push_back(SqErrA4[i]*((delta[i][0]+(-(F4[0]-A4[i]+F4[2]-A4[i])/(2*sqrt(F4[1]*F4[1]-(F4[2]-A4[i])*(F4[0]-A4[i])))))/(F4[2]-A4[i]))*((delta[i][0]+((F4[0]-A4[i]+F4[2]-A4[i])/(2*sqrt(F4[1]*F4[1]-(F4[2]-A4[i])*(F4[0]-A4[i])))))/(F4[2]-A4[i])));
    }
  return delta;
}
